...
const cards = [
  {
    ...
    img: image1,
    socials: {
      linkedin: "https://www.linkedin.com/in/mohamedeidprofile/",
      Github: "https://github.com/IbnEid",
      whatsapp: "#",
      instagram: "#",
    },
  },

  {
    ...
    img: image2,
    socials: {
      linkedin: "https://www.linkedin.com/in/abdel-rahman-elghazaly-8278162b4/",
      Github: "https://github.com/abdelrhmanwan",
      whatsapp: "#",
      instagram: "#",
    },
  },

  {
    ...
    img: image3,
    socials: {
      linkedin: "https://www.linkedin.com/in/omar-yasser-96613b357/",
      Github: "https://github.com/Omyaseer",
      whatsapp: "#",
      instagram: "#",
    },
  },

  {
    ...
    img: image4,
    socials: {
      linkedin: "http://www.linkedin.com/in/abdelrahman-maged-8008a0344",
      Github: "https://github.com/abdelrahmenmaged",
      whatsapp: "#",
      instagram: "#",
    },
  },
      ...
      <Container className="about-container p-5 container">
        <Row className="align-items-center pt-5 pb-5 mt-5  mb-5 about-row-1">
          <Col lg={6} md={12}>
            ...
            <p>
              Dealwala has more than 1 billion products to offer, growing at a
              very fast rate while offering a diverse assortment in categories
        ...
        <div className="dots pt-5 ">
          {cards.map((_, idx) => (
            <span
              ...
              style={{
                background: activeIndex === idx ? "#DB4444" : "#c0c0c0",
                cursor: "pointer",
                transition: "0.3s",
              }}
            >
