...
function CreatAccount() {
  const [create, setCreate] = useState({ email: "", password: "", name: "" });
  ...
  const CheckDtata = async (e) => {
    ...
    if (!create.email.trim() || !create.password.trim() || !create.name.trim()) {
      setError("⚠️ Please enter email, name and password");
      setLoading(false);
      return 
    }
