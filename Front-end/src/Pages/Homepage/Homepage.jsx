    ...
    <>
          ...
          <div className="card bg-black text-white shadow-lg rounded-3">
            <div className="container px-4 p-5 g-4">
              <div className="row gx-5">
                <div className="col px-md-5 ms-4">

                  <div className="d-flex pt-3 pb-4 g-1 flex-wrap">
                    <div>
                      <img style={{ width: "30px" }}src="./image/download.png"alt/>
                    </div>
                  ...
                  <Link to="/products" className="border-bottom text-decoration-none text-white border-white pb-1"
                ...
                <div className="col m-auto d-flex justify-content-center align-items-center">
                  <img className="img-shoes" src="./image/shoes.png" alt="shoes"/>
                </div>
            ...
            <div className="">
              <div className="bg-body-secondary text-center position-relative ">
                ...
                <Changecoulor
                  product={{
                    id: "flash-4",
                    name: "HAVIT HV-G92 Gamepad (Football Edition)",
                    price: 150,
                    originalPrice: 200,
      ...
      <section className="cards m-auto px-3 px-md-5">
        <div className="container px-3 px-md-4 py-4 py-md-5">
          ...
          <div className="d-flex flex-wrap justify-content-between gap-3 pb-4">
            <h2 className="mx-md-3 mx-lg-4 px-2 mx-5">Best Selling Products</h2>

            <Link to="/products" className="btn btn-danger me-md-4 me-0 ms-md-0 ms-4 ps-5 pe-5 pt-2 pb-2"
              style={{ width: "fit-content", borderRadius: "6px" }}>
              View All Products
            </Link>
          </div>
          ...
          <div className="boxes-list">
            <div className="">
              <div className="bg-body-secondary text-center position-relative">
                <Changecoulor
                  product={{
                    id: "best-1",
                    name: "new Real Madrid tee-shirt",
                    price: 120,
                    originalPrice: 160,
                    img: "./image/realmadrid.png",
                  }}/>
                <img src="./image/realmadrid.png" className="img-layout"alt="..."/>
              </div>
            ...
            <div className="">
              <div className="bg-body-secondary text-center position-relative ">
                ...
                <img src="./image/basketball.png" className="img-fluid p-lg-5 p-4 mt-5 mt-lg-0 "alt="..."/>
              </div>
            ...
            <div className="container px-4 p-5 g-4">
              <div className="row gx-5">
                <div className="col px-sm-5 px-2 ms-4">
                  ...
                  <Link to="/Checkout"className="btn btn-success bg-gradient px-5 py-2 fw-bold"
                  style={{ width: "fit-content", borderRadius: "6px" 
                  }}>
                    Buy Now!
                  </Link>
      ...
      <section className="cards2 m-auto px-3 px-md-5">
        <div className="container px-3 px-md-4 py-4 py-md-5">
            ...
            <div className>
              <div className="bg-body-secondary text-center position-relative">
                <Changecoulor
                  product={{
                    id: "explore-1",
                    name: "Skillrun Live 7000",
                    price: 1500,
                    img: "./image/skillrun.png",
                  }}
                />
            ...
            <div className>
              <div className="bg-body-secondary text-center position-relative ">
                <Changecoulor
                  product={{
                    id: "explore-4",
                    name: "keypoard gaming",
                    price: 150,
                    img: "./image/gamingkeyboard.png",
                  }}
                />
            ...
            <div className>
              <div className="bg-body-secondary text-center position-relative ">
                <Changecoulor
                  product={{
                    id: "explore-8",
                    name: "basketball-uniforms trainning",
                    price: 60,
                    img: "./image/tee-shirtbasketball.png",
                  }}
                />
          ...
          <Link
            to="/products"
            className="btn btn-danger text-white text-decoration-none d-block mx-auto mt-5 text-center px-4 py-2"
            style={{ width: "fit-content", borderRadius: "6px" }}
          >
            View All Products
          </Link>
